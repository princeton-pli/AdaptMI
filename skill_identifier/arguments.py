...
def parse_arguments():
    ...
    # Ours
    parser.add_argument("--label_skill", action="store_true", help="if true, call load PRM data")
    parser.add_argument("--label_problem", action="store_true", help="if true, call load problem data")
    parser.add_argument("--label_feedback", action="store_true", help="if true, call load skill data")
    parser.add_argument("--llm_sol", action="store_true", help="if true, call load skill bank data")
    parser.add_argument("--subject", type=str, default="geometry")
    ...
    parser.add_argument("--demo_files", type=str, default="")
    parser.add_argument("--test_files", type=str, default="")
    parser.add_argument("--output_dir", type=str, default="", help="path to save the predictions")
    ...
    parser.add_argument("--generation_max_length", type=str, default='1024', help="max number of tokens to generate, can be separated by comma to match the specified datasets")
